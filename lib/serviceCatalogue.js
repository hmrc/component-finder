 ...
 * @param progressBar
 */
const gitCloneTask = (resolve, reject, sshGitHubUrl, repoName, progressBar) => {
 ...
 * @param services
 * @param [cloneTask=gitCloneTask]
 * @returns {Array[Promise]}
 */
const prepClone = (services, cloneTask = gitCloneTask) => {
  ...
  return gitHubDetails.map(githubDetail => {
    ...
    return new Promise((resolve, reject) => {
      cloneTask(resolve, reject, sshGitHubUrl, repoName, progressBar);
    });
  });
};
